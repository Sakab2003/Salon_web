    ...
    <div class="row mb-2">
      <div class="col-12">
        <div class="form-group" v-if="branch.options.length > 1">
          ...
          <Multiselect id="branch_id" v-model="branch_id" placeholder="Selectionner un salon" v-bind="singleSelectOption" :options="branch.options" @select="branchSelect" class="form-group"></Multiselect>
