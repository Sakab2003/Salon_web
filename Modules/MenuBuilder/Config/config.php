...
return [
    ...
    'ARRAY_MENU' => [
        ...
        [
            'start_icon' => 'fa-solid fa-cash-register',
            'title' => 'sidebar.pos_sale',
            'route' => 'backend.orders.pos',
            'active' => ['app/ventes/nouvelle-vente*'],
            'permission' => ['view_product'],
            'order' => 7.5,
        ],
        [
            'start_icon' => 'fa-solid fa-boxes-stacked',
            'title' => 'sidebar.products_stock',
        ...
        [
            'start_icon' => 'fa-solid fa-clock-rotate-left',
            'title' => 'sidebar.sales_history',
            'route' => 'backend.orders.index',
            'active' => ['app/orders*', 'app/ventes/historique*'],
            'permission' => ['view_product'],
            'order' => 7.7,
        ],
        [
        ...
        [
            ...
            'title' => 'sidebar.financial_balance',
            'route' => 'backend.reports.financial_balance',
            'active' => ['app/bilan-financier*'],
