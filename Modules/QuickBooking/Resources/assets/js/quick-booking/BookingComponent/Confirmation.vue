<template>
  <div class="card-list-data">
    <div class="text-center">
      ...
      <h5>Votre rendez-vous est pris avec succès !</h5>
      <p class="mt-3">Veuillez vérifier votre courrier électronique pour vérification</p>
      <hr />
      <div class="non-printable">
        <div class="d-flex flex-wrap gap-1 justify-content-center">
          <button type="button" class="btn btn-primary d-flex gap-3" @click="reset">
            ...
            <span>Prendre plus de rendez-vous</span>
          </button>
