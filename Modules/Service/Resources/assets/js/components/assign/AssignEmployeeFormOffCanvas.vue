        ...
        <div class="form-group">
          <div class="d-grid">
            <div class="d-flex flex-column">
              <div class="mb-4">
                <!-- <Multiselect id="branch_id" placeholder="Selectionner un salon" v-model="branch_id" :value="branch_id" v-bind="singleSelectOption" :options="branch.options" @select="branchSelect" class="form-group mb-3"></Multiselect> -->
