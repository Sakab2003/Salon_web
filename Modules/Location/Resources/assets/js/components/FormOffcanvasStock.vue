    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="form-offcanvas-stock" aria-labelledby="form-offcanvas-stockLabel">
      ...
      <div class="offcanvas-body">
        ...
        <div class="form-group col-md-12">
          ...
          <Multiselect id="categories" v-model="category_id" :value="category_id" placeholder="Selectionner la catégorie" v-bind="multiselectOption" :options="category.options" @select="selectCategory" class="form-group"></Multiselect>
        ...
        <div class="form-group">
          ...
          <Multiselect id="product_id-list" v-model="product_id" :value="product_id" v-bind="singleSelectOption" placeholder="Selectionner le produit" :options="products.options" class="form-group" @select="getProductVariationsData"></Multiselect>
